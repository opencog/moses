find_library(COGUTIL_LIBRARY   NAMES cogutil  PATH /usr/lib /usr/lib64)
...
CHECK_INCLUDE_FILES (Loggery.h HAVE_COGUTIL_H)
...
if ( COGUTIL_FOUND )
	...
	message( STATUS "CigUtil not found")
endif ( COGUTIL_FOUND )
